...
export default function Simple() {
  ...
  const courseSubscript = 'Beginner 2 | 2 weeks | 4 Tests'
  const courseDescription = 'Make your basics stronger with this course.'
  ...
  const courseImage = 'https://leverageedublog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2020/07/06205913/Masters-in-Computer-Science-800x500.jpg'
