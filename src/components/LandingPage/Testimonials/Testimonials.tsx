        ...
        <Stack
          ...
          <Testimonial>
            <TestimonialContent>
              ...
              <TestimonialText>
              An Innovative Idea that is executed very well. I like the clean and user-friendly design. It helped me to get the individual attention I needed.
              </TestimonialText>
            </TestimonialContent>
            <TestimonialAvatar
              src={
              ...
              name={'Taranvir Singh'}
              title={'Professor at JIT, CSE Department '}
            />
          </Testimonial>
          <Testimonial>
            <TestimonialContent>
          ...
          <Testimonial>
            <TestimonialContent>
              ...
              <TestimonialText>
              I loved the layout of the website and, the innovative technology used to help me learn. It simplified many concepts and the interactive sessions and made me remember easily.
              </TestimonialText>
            </TestimonialContent>
            <TestimonialAvatar
              src={
              ...
              title={'Student CSE department, JIT'}
            />
          </Testimonial>
        </Stack>
      </Container>
